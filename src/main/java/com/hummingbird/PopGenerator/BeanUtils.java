...
public class BeanUtils {
	...
	private static final String BEAN_INDEX_TEMPLATE_VM_PATH = "index1.vm";
    ...
    private  BeanModel bean = new BeanModel();
...
//        annotation.setAuthorMail("hongtenzone@foxmail.com");
	...
	public void createSuite(File outputDirectory) throws Exception {
		String fileName = bean.getName() + "test.jsp.txt";
